...
* Used the [themovidbapi](https://github.com/holgerbrandl/themoviedbapi) to avoid having to do tedious JSON parsing. Will try out OkHttp in a new branch to learn its semantics.
* Used the android.os.AsyncTask to call this API
